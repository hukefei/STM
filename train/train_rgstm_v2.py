...
def parse_args():
    ...
    parser.add_argument('--work_dir', type=str, default='./exp/rgstm_res50_v2', help='the dir to save models.pth and logs and masks')
    ...
    parser.add_argument("--gpu", type=str, default='1', help="0; 0,1; 0,3; etc")
