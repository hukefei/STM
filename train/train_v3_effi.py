...
from models.models_effi.model_b5 import STM
...
def parse_args():
    ...
    parser.add_argument('--work_dir', type=str, default='./exp/effi_b5_v3.3', help='the dir to save models.pth and logs and masks')
    parser.add_argument("--mode", type=str, default='train', help="train or val")
    parser.add_argument('--load_from', type=str, default='/cfs/yuanlei/my_stm/exp/effi_b5_v3.2/ckpt/youtube/ckpt_0036.pth')
    # train
