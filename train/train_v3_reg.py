...
from models.pycls.tools.model_stm import STM
...
def parse_args():
    ...
    parser.add_argument('--work_dir', type=str, default='./exp/reg800M_v3.3.FF_first_pre', help='the dir to save models.pth and logs and masks')
    parser.add_argument("--mode", type=str, default='val', help="train or val")
    parser.add_argument('--load_from', type=str, default='/cfs/yuanlei/my_stm/exp/reg800M_v3.3/ckpt/davis/ckpt_0187.pth')
    # train
